...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Stack Project</h1>\n  <p class=\"lead\">Welcome to my MEAN Stack Project! This project has been built on top of Traversy Media's YouTube tutorial project \n    <a href=\"https://www.youtube.com/playlist?list=PLillGF-RfqbZMNtaOXJQiDebNXjVapWPZ\">MEAN Stack Front To Back</a> and is meant to \n    be a demonstration project of my MEAN skills. I'm planning on possibly expanding this project in the future by adding new functionalities.\n    </p>\n    <p *ngIf=\"!authService.loggedIn()\">By logging in you get access to all kinds of incredible features!!! Register a new account if you \n      haven't one yet by choosing 'Register'.</p>\n  <div>\n    <a class=\"btn btn-primary\" *ngIf=\"!authService.loggedIn()\" [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-dark\" *ngIf=\"!authService.loggedIn()\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n"
...
var appRoutes = [
    ...
    { path: 'map', component: _components_map_map_component__WEBPACK_IMPORTED_MODULE_10__["MapComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_13__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]] }
];
...
module.exports = "agm-map {\r\n    height: 300px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MapComponent = /** @class */ (function () {
    function MapComponent() {
        this.title = 'Google Maps Integrated';
        this.lat = 61.065021;
        this.lng = 28.094492;
    }
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('http://localhost:3000/users/register', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }));
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/authenticate', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }));
    };
...
module.exports = __webpack_require__(/*! C:\Users\juhoh\Desktop\software dev skills\project\angular-src\src\main.ts */"./src/main.ts");
